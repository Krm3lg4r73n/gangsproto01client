...
export const msg = $root.msg = (() => {
    ...
    msg.LocationUpdate = (function() {

        /**
         * Properties of a LocationUpdate.
         * @memberof msg
         * @interface ILocationUpdate
         * @property {string} [name] LocationUpdate name
         */
         ...
         * @constructor
         * @param {msg.ILocationUpdate=} [properties] Properties to set
         */
         ...
         * LocationUpdate name.
         * @member {string}name
         * @memberof msg.LocationUpdate
         * @instance
         */
        LocationUpdate.prototype.name = "";
         ...
         * @static
         * @param {msg.ILocationUpdate=} [properties] Properties to set
         * @returns {msg.LocationUpdate} LocationUpdate instance
         */
        ...
        /**
         * Encodes the specified LocationUpdate message. Does not implicitly {@link msg.LocationUpdate.verify|verify} messages.
         * @function encode
         * @memberof msg.LocationUpdate
         * @static
         * @param {msg.ILocationUpdate} message LocationUpdate message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        ...
        /**
         * Encodes the specified LocationUpdate message, length delimited. Does not implicitly {@link msg.LocationUpdate.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.LocationUpdate
         * @static
         * @param {msg.ILocationUpdate} message LocationUpdate message or plain object to encode
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.LocationUpdate} LocationUpdate
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LocationUpdate.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.msg.LocationUpdate();
            while (reader.pos < end) {
                let tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        LocationUpdate.fromObject = function fromObject(object) {
            if (object instanceof $root.msg.LocationUpdate)
                return object;
            let message = new $root.msg.LocationUpdate();
            if (object.name != null)
                message.name = String(object.name);
            return message;
        };
         ...
         * @memberof msg.LocationUpdate
         * @static
         * @param {msg.LocationUpdate} message LocationUpdate
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
